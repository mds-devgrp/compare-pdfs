...
以下を報告する:
- 作成したタグ名
- GitHub Actions の実行確認 URL: `https://github.com/mds-devgrp/compare-pdfs/actions`
- Release ページ URL: `https://github.com/mds-devgrp/compare-pdfs/releases/tag/v$ARGUMENTS`
